...
import { CategoryMap, PivotCatalogs } from "@/integrations/supabase";
...
interface PivotsCategoriesTabProps {
  categoryMap: CategoryMap | null | undefined;
  pivotCatalogs: PivotCatalogs | null | undefined;
}

export default function PivotsCategoriesTab({ categoryMap, pivotCatalogs }: PivotsCategoriesTabProps) {
